...
KeyPing source code is licensed under the MIT License.

However, the **KeyPing** name, logo, iconography, and branding are not granted under the MIT License.
These brand assets remain reserved by the project owner.
